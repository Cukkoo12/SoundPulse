...
public class ConfigManager {
    ...
    private static final Path CONFIG_PATH = FabricLoader.getInstance()
            .getConfigDir().resolve("soundpulse.json");
    ...
    /**
     * Kategoriye ait ARGB rengini döndürür. Özel renk tanımlanmamışsa varsayılan kullanılır.
     */
    ...
    /**
     * Bir kategori için özel renk belirler ve kaydeder.
     */
